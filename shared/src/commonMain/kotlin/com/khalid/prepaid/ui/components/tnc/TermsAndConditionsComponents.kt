package com.khalid.prepaid.ui.components.tnc
...
import com.khalid.prepaid.ui.theme.prepaidIndigo
import com.khalid.prepaid.ui.theme.prepaidYellow
...
internal fun tcScreenComposable(
    ...
    Scaffold(
        ...
        topBar = { topBarComposable(scrollBehavior) },
        bottomBar = { bottomComposable(onAcceptTC) },
        content = { contentComposable(it) }
    )
}
...
@Composable
fun bottomComposable(onAcceptTC : ()-> Unit) {
    Row (
        ...
        Button(
            ...
            modifier = Modifier.fillMaxWidth().padding(
                ...
                bottom = 10.dp),
            onClick = onAcceptTC){
            Text(modifier = Modifier, text = "I agree", color = Color.Black,)
        }
    }
}
...
@Composable
fun contentComposable(innerPaddingValues: PaddingValues) {
    LazyColumn(
...
@Composable
fun topBarComposable(scrollBehavior: TopAppBarScrollBehavior) {
